...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: {
      ...
      languages: { en: '/en/plants/', 'zh-CN': '/zh-CN/plants/' },
    },
  };
}
export default async function PlantsPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const t = await getTranslations('plants'),
    c = await getTranslations('catalog');
  return (
    <div className="reference-page">
      <SiteHeader locale={locale} />
      <main id="main-content" className="reference-main">
        ...
        <ClientMessages namespaces={['plants', 'catalog']}>
          <PlantReference />
        </ClientMessages>
      </main>
    </div>
