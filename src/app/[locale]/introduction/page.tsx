...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: {
      ...
      languages: { en: '/en/introduction/', 'zh-CN': '/zh-CN/introduction/' },
    },
  };
}
  ...
  return (
    <div className="about-page">
      ...
      <main id="main-content" className="about-main">
        ...
        <aside className="sample-identity">
          <span className="eyebrow">{t('sample')}</span>
          <span>ARM64 / SHA-256</span>
          <code>{baseline.sample.executableSha256}</code>
        </aside>
        <Link href="/wave-plan/" className="text-link">
          {t('startChapter')} →
        </Link>
      </main>
