...
The handler also suppresses requests before the first wave. Its boundary expression does not independently inspect the final-wave marker. With $s=5$, current wave 4 is guarded; current wave 12 before a short final wave 13 is not guarded by this expression.
