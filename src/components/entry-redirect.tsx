...
export function EntryRedirect() {
  ...
  return (
    <main style={{ maxWidth: 560, margin: '18vh auto', padding: 32 }}>
      <p>PVZ2 / ENDLESS</p>
      <h1>Endless, explained.</h1>
      <p>
        <a href="/en/" style={{ color: 'inherit', marginRight: 24 }}>
          English →
        </a>
        <a href="/zh-CN/" lang="zh-CN" style={{ color: 'inherit' }}>
          中文 →
        </a>
      </p>
    </main>
